...
QT_MOC_LITERAL(1, 13, 15), // "back_mainWindow"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 32) // "on_toolButton_mainWindow_clicked"

    },
    "Oscilloscope\0back_mainWindow\0\0"
    "on_toolButton_mainWindow_clicked"
};
...
void Oscilloscope::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_toolButton_mainWindow_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Oscilloscope::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Oscilloscope::back_mainWindow)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Oscilloscope::back_mainWindow()
{
