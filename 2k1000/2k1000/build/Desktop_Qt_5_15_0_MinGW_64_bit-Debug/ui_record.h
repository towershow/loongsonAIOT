...
public:
    ...
    void setupUi(QMainWindow *Record)
    {
        ...
        Record->resize(1920, 1017);
        centralwidget = new QWidget(Record);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        listView = new QListView(centralwidget);
        listView->setObjectName(QString::fromUtf8("listView"));
        listView->setGeometry(QRect(0, 0, 1920, 1017));
        listView->setStyleSheet(QString::fromUtf8("background-image: url(:/images/record_ui/background.png);"));
        label = new QLabel(centralwidget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(60, 0, 441, 165));
        label->setStyleSheet(QString::fromUtf8("image: url(:/images/record_ui/Gowin_logo.png);"));
        ...
        label_2->setGeometry(QRect(1320, 100, 231, 51));
        label_2->setStyleSheet(QString::fromUtf8("image: url(:/images/record_ui/button_bottom.png);"));
